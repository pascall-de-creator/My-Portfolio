      ...
      <section className="w-screen">
        <div className="container mx-auto flex flex-col items-center justify-center overflow-hidden">
          ...
          <div className="grid grid-flow-row grid-cols-2 md:grid-cols-4 gap-2 md:gap-4 p-2 m-3 mb-5">
            <div className="p-4 bg-gray-50 dark:bg-slate-700 rounded-md shadow-md flex flex-col hover:scale-105 cursor-pointer">
            ...
            <div className="p-4 bg-gray-50 dark:bg-slate-700 rounded-md shadow-md flex flex-col hover:scale-105 cursor-pointer">
              ...
              <p className='text-base dark:text-white'>I develop cross-platform mobile software with full functionality </p>
            </div>
            <div className="p-4 bg-gray-50 dark:bg-slate-700 rounded-md shadow-md flex flex-col hover:scale-105 cursor-pointer">
        ...
        <div className="container mx-auto flex flex-col items-center justify-center">
          ...
          <div className="grid grid-flow-row grid-cols-2 md:grid-cols-4 gap-2 md:gap-4 p-2 m-3">
            <div className="p-4 bg-gray-50 dark:bg-slate-700 rounded-md shadow-md flex flex-col items-center hover:scale-105 cursor-pointer">
              ...
              <p className='text-base dark:text-white text-center'>Developing along side other developers and working together on projects</p>
            </div>
            <div className="p-4 bg-gray-50 dark:bg-slate-700 rounded-md shadow-md flex flex-col items-center hover:scale-105 cursor-pointer">
