    ...
    return ( 
        <>
            <div className="w-screen bottom-0 rounded-none md:w-max fixed md:bottom-4 md:rounded-md md:opacity-90 bg-white dark:bg-slate-900 backdrop-blur-md shadow-2xl p-1 flex items-center justify-around">
                ...
                <Link href="/skills"><a title="Skills" className={`text-3xl mx-2 p-4 bg-white dark:bg-slate-900 dark:text-white rounded-md hover:-translate-y-5 hover:scale-110 hover:shadow-md hover:text-primary hover:opacity-100 ${ route == 'skills' ? 'text-primary' : ' ' }`}>{ route === 'skills'? <BsBookFill /> : <BsBook /> }</a></Link>
                <Link href="/achivements"><a title="Achivements" className={`hidden text-3xl sm:block mx-2 p-4 bg-white dark:bg-slate-900 dark:text-white rounded-md hover:-translate-y-5 hover:scale-110 hover:shadow-md hover:text-primary hover:opacity-100 ${ route == 'achivements' ? 'text-primary' : ' ' }`}>{ route === 'achivements'? <AiFillTrophy /> : <AiOutlineTrophy/> }</a></Link>
